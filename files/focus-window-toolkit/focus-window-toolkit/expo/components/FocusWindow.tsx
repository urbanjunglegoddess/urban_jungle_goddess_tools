...
const s = StyleSheet.create({
  ...
  startbtnTxt: { color: "#14100a", fontWeight: "800", fontSize: 16 },
  ...
  now: { backgroundColor: "#123322", borderColor: T.goldDeep, borderWidth: 1.5, borderRadius: 16, padding: 16, marginBottom: 14 },
  ...
  runRowActive: { backgroundColor: "rgba(232,200,106,0.06)", borderRadius: 9, paddingHorizontal: 8 },
