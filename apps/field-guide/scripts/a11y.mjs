/**
 * WCAG 2.1 AA audit of the built site, in both themes, with axe-core.
 *
...
for (const [label, url, theme] of [
  ["index (dark)", "http://localhost:4322/", "dark"],
  ["index (light)", "http://localhost:4322/", "light"],
  ["platform page (dark)", "http://localhost:4322/wix-studio", "dark"],
  ["platform page (light)", "http://localhost:4322/wix-studio", "light"],
]) {
