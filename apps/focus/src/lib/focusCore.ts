 ...
 * Pure functions, zero DOM, zero framework. Every tool page imports this one copy —
 * before the move into apps/ there were four copies of this file drifting apart in
 * work-assist/real. Nothing here touches storage, styling, timers or sound; those
 * live in the shell (src/scripts/focus.ts).
 */
